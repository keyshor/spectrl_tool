...
params_list = [HyperParams(30, 1, 1500, 20, 8, 0.05, 1, 0.2),
               HyperParams(30, 1, 1500, 20, 8, 0.05, 0.6, 0.1),
               HyperParams(30, 1, 1500, 20, 8, 0.05, 0.5, 0.1),
               HyperParams(30, 1, 1500, 20, 8, 0.05, 0.6, 0.1),
               HyperParams(30, 1, 2000, 30, 8, 0.02, 0.3, 0.1),
               HyperParams(30, 1, 10000, 30, 8, 0.01, 0.2, 0.05),
               HyperParams(30, 1, 15000, 30, 5, 0.008, 0.1, 0.05)]
...
if __name__ == '__main__':
    ...
    for i in range(len(specs)):
        ...
        env = ProductMDP(system, 2, specs[i], 0.0,
                         lb[i], res_model=resource) if fuel[i] else ProductMDP(system, 2,
                                                                               specs[i], 0.0, lb[i])
